...
int main(){
 static_assert(state_field_capacity==8&&command_field_capacity==4);assert(field_index(RFReferenceFrequency::id)==4&&field_index(Bandwidth::id)==5&&field_index(Gain::id)==6&&field_index(DiscreteIO32::id)==7);
