...
| M5 | Documented operational profile and retained bounded generic codecs; Array-of-CIFs excluded | Independent evidence for advertised capabilities, explicit exclusions, profile isolation, variable-layout/attribute/sample checks; D-M5-1 scope |
