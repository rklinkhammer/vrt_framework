...
| M4 | Compiled UDP adapter and reference capacity enforcement | Four-stream measured benchmark; malformed input fuzzing; overload; shutdown with late callbacks; independent peer traces |
