...
The live aggregate integration gate is recorded separately in [M5 progress](M5-integration.md). The evidence above identifies component verification and does not by itself approve the aggregate tree.
